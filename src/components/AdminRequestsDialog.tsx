    ...
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogTrigger asChild>
        <Button variant="outline" size="sm" className="gap-2 relative">
          ...
          בקשות שדרוג
          {pendingCount > 0 && (
            <span dir="ltr" className="absolute -top-2 -right-2 bg-destructive text-destructive-foreground text-xs rounded-full h-5 w-5 flex items-center justify-center">
              {pendingCount}
            </span>
          )}
        </Button>
