      ...
      <div className="container flex h-16 items-center justify-between px-4" dir={dir}>
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <Link to="/" className="flex items-center gap-2 sm:gap-3 group">
            ...
            <span className="text-lg sm:text-xl font-bold bg-gradient-to-r from-foreground via-foreground/90 to-foreground/80 bg-clip-text text-transparent">motorClub il</span>
          </Link>
