        ...
        <div className="prose prose-sm dark:prose-invert max-w-none">
          {lang === "he" ? (
            <>
              ...
              <p className="text-muted-foreground mb-8">עודכן לאחרונה: 29 בדצמבר 2025</p>

              <p className="mb-6">
                הודעת פרטיות זו עבור motorClub il ("אנחנו", "שלנו") מתארת כיצד ומדוע אנו עשויים לגשת, לאסוף, לאחסן, להשתמש ו/או לשתף ("לעבד") את המידע האישי שלך כאשר אתה משתמש בשירותים שלנו ("השירותים"), כולל כאשר אתה:
              </p>

              <ul className="list-disc pl-6 mb-6 space-y-2">
                <li>מבקר באתר שלנו בכתובת https://www.motorclub.co.il או בכל אתר שלנו המקושר להודעת פרטיות זו</li>
                <li>מוריד ומשתמש באפליקציה הניידת שלנו (motorclub), או בכל אפליקציה אחרת שלנו המקושרת להודעת פרטיות זו</li>
                <li>מתקשר איתנו בדרכים קשורות אחרות, כולל שיווק או אירועים</li>
              </ul>

              <p className="mb-8">
                שאלות או חששות? קריאת הודעת פרטיות זו תעזור לך להבין את זכויות הפרטיות והבחירות שלך. אנו אחראים לקבלת החלטות לגבי אופן עיבוד המידע האישי שלך. אם אינך מסכים עם המדיניות והנהלים שלנו, אנא אל תשתמש בשירותים שלנו. אם עדיין יש לך שאלות או חששות, אנא צור איתנו קשר בכתובת <a href="mailto:yoni2435@gmail.com" className="text-primary hover:underline">yoni2435@gmail.com</a>.
              </p>

              <h2 className="text-2xl font-bold mt-8 mb-4">סיכום נקודות מפתח</h2>
              <p className="mb-4 italic">סיכום זה מספק נקודות מפתח מהודעת הפרטיות שלנו.</p>

              <div className="space-y-4 mb-8">
                <p><strong>איזה מידע אישי אנו מעבדים?</strong> כאשר אתה מבקר, משתמש או מנווט בשירותים שלנו, אנו עשויים לעבד מידע אישי בהתאם לאופן שבו אתה מתקשר איתנו ועם השירותים, הבחירות שאתה עושה והמוצרים והתכונות שבהם אתה משתמש.</p>
                
                <p><strong>האם אנו מעבדים מידע אישי רגיש?</strong> אנו לא מעבדים מידע אישי רגיש.</p>
                
                <p><strong>האם אנו אוספים מידע מצדדים שלישיים?</strong> אנו לא אוספים מידע מצדדים שלישיים.</p>
                
                <p><strong>כיצד אנו מעבדים את המידע שלך?</strong> אנו מעבדים את המידע שלך כדי לספק, לשפר ולנהל את השירותים שלנו, לתקשר איתך, לאבטחה ומניעת הונאות ולציית לחוק.</p>
                
                <p><strong>כיצד אנו שומרים על בטיחות המידע שלך?</strong> יש לנו תהליכים ונהלים ארגוניים וטכניים מתאימים להגנה על המידע האישי שלך. עם זאת, אף העברה אלקטרונית באינטרנט או טכנולוגיית אחסון מידע אינה יכולה להיות מובטחת כ-100% מאובטחת.</p>
                
                <p><strong>מהן הזכויות שלך?</strong> בהתאם למיקום הגיאוגרפי שלך, חוק הפרטיות החל עשוי להעניק לך זכויות מסוימות לגבי המידע האישי שלך.</p>
              </div>

              <h2 className="text-2xl font-bold mt-8 mb-4">1. איזה מידע אנו אוספים?</h2>
              <h3 className="text-xl font-semibold mb-2">מידע אישי שאתה מגלה לנו</h3>
              <p className="mb-4"><em>בקצרה: אנו אוספים מידע אישי שאתה מספק לנו.</em></p>
              
              <p className="mb-4">אנו אוספים מידע אישי שאתה מספק לנו מרצונך כאשר אתה נרשם לשירותים, מביע עניין בקבלת מידע עלינו או על המוצרים והשירותים שלנו, כאשר אתה משתתף בפעילויות בשירותים, או כאשר אתה יוצר איתנו קשר.</p>
              
              <p className="mb-2"><strong>מידע אישי שסופק על ידך.</strong> המידע האישי שאנו אוספים תלוי בהקשר של האינטראקציות שלך איתנו ועם השירותים, הבחירות שאתה עושה והמוצרים והתכונות שבהם אתה משתמש. המידע האישי שאנו אוספים עשוי לכלול:</p>
              ...
              <p className="mb-4"><strong>מידע רגיש.</strong> אנו לא מעבדים מידע רגיש.</p>

              <p className="mb-2"><strong>נתוני אפליקציה.</strong> אם אתה משתמש באפליקציה/ות שלנו, אנו עשויים גם לאסוף את המידע הבא אם תבחר לספק לנו גישה או הרשאה:</p>
              <ul className="list-disc pl-6 mb-4 space-y-2">
                <li><em>מידע מיקום.</em> אנו עשויים לבקש גישה או הרשאה לעקוב אחר מידע מבוסס מיקום מהמכשיר הנייד שלך, באופן רציף או בזמן שאתה משתמש באפליקציה הניידת שלנו, כדי לספק שירותים מסוימים מבוססי מיקום. אם ברצונך לשנות את הגישה או ההרשאות שלנו, תוכל לעשות זאת בהגדרות המכשיר שלך.</li>
                <li><em>גישה למכשיר נייד.</em> אנו עשויים לבקש גישה או הרשאה לתכונות מסוימות מהמכשיר הנייד שלך, כולל המצלמה, המיקרופון, האחסון, המיקום ותכונות אחרות של המכשיר הנייד שלך. אם ברצונך לשנות את הגישה או ההרשאות שלנו, תוכל לעשות זאת בהגדרות המכשיר שלך.</li>
              </ul>

              <p className="mb-8">מידע זה נדרש בעיקר לשמירה על האבטחה והתפעול של האפליקציה/ות שלנו, לפתרון בעיות ולמטרות הניתוח והדיווח הפנימיים שלנו. כל המידע האישי שאתה מספק לנו חייב להיות אמיתי, מלא ומדויק, ועליך להודיע לנו על כל שינוי במידע אישי כזה.</p>

              <h2 className="text-2xl font-bold mt-8 mb-4">2. כיצד אנו מעבדים את המידע שלך?</h2>
              <p className="mb-4"><em>בקצרה: אנו מעבדים את המידע שלך כדי לספק, לשפר ולנהל את השירותים שלנו, לתקשר איתך, לאבטחה ומניעת הונאות ולציית לחוק.</em></p>
              
              <p className="mb-2">אנו מעבדים את המידע האישי שלך ממגוון סיבות, בהתאם לאופן שבו אתה מתקשר עם השירותים שלנו, כולל:</p>
              <ul className="list-disc pl-6 mb-8 space-y-2">
                <li><strong>להקל על יצירת חשבון ואימות</strong> ולנהל חשבונות משתמש בדרך אחרת. אנו עשויים לעבד את המידע שלך כדי שתוכל ליצור ולהיכנס לחשבונך, וכן לשמור על חשבונך בסדר תקין.</li>
                <li><strong>לספק ולהקל על אספקת שירותים למשתמש.</strong> אנו עשויים לעבד את המידע שלך כדי לספק לך את השירות המבוקש.</li>
                <li><strong>לאפשר תקשורת בין משתמשים.</strong> אנו עשויים לעבד את המידע שלך אם תבחר להשתמש בכל אחת מההצעות שלנו המאפשרות תקשורת עם משתמש אחר.</li>
                <li><strong>לספק פרסום ממוקד.</strong> אנו עשויים לעבד את המידע שלך כדי לפתח ולהציג תוכן ופרסום מותאמים אישית לתחומי העניין, המיקום שלך ועוד.</li>
                <li><strong>להעריך ולשפר את השירותים, המוצרים, השיווק והחוויה שלך.</strong> אנו עשויים לעבד את המידע שלך כאשר אנו מאמינים שזה הכרחי לזהות מגמות שימוש, לקבוע את האפקטיביות של מסעות הפרסום שלנו ולהעריך ולשפר את השירותים, המוצרים, השיווק והחוויה שלך.</li>
                <li><strong>לזהות מגמות שימוש.</strong> אנו עשויים לעבד מידע על אופן השימוש שלך בשירותים שלנו כדי להבין טוב יותר כיצד הם משמשים כדי שנוכל לשפר אותם.</li>
              </ul>

              <h2 className="text-2xl font-bold mt-8 mb-4">3. מתי ועם מי אנו משתפים את המידע האישי שלך?</h2>
              <p className="mb-8">אנו עשויים לשתף מידע במצבים ספציפיים המתוארים בסעיף זה ו/או עם צדדים שלישיים ספציפיים.</p>

              <h2 className="text-2xl font-bold mt-8 mb-4">4. מהי עמדתנו לגבי אתרי צד שלישי?</h2>
              <p className="mb-8"><em>בקצרה: איננו אחראים לבטיחות של כל מידע שאתה משתף עם צדדים שלישיים שאנו עשויים לקשר אליהם או שמפרסמים בשירותים שלנו, אך אינם קשורים לשירותים שלנו.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">5. האם אנו משתמשים בעוגיות וטכנולוגיות מעקב אחרות?</h2>
              <p className="mb-8"><em>בקצרה: אנו עשויים להשתמש בעוגיות וטכנולוגיות מעקב אחרות לאיסוף ואחסון המידע שלך.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">6. האם אנו מציעים מוצרים מבוססי בינה מלאכותית?</h2>
              <p className="mb-8"><em>בקצרה: אנו מציעים מוצרים, תכונות או כלים המופעלים על ידי בינה מלאכותית, למידת מכונה או טכנולוגיות דומות.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">7. כמה זמן אנו שומרים את המידע שלך?</h2>
              <p className="mb-8"><em>בקצרה: אנו שומרים את המידע שלך למשך הזמן הנדרש למילוי המטרות המתוארות בהודעת פרטיות זו, אלא אם כן נדרש אחרת על פי חוק.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">8. כיצד אנו שומרים על בטיחות המידע שלך?</h2>
              <p className="mb-8"><em>בקצרה: אנו שואפים להגן על המידע האישי שלך באמצעות מערכת של אמצעי אבטחה ארגוניים וטכניים.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">9. מהן זכויות הפרטיות שלך?</h2>
              <p className="mb-8"><em>בקצרה: אתה רשאי לסקור, לשנות או לסיים את חשבונך בכל עת, בהתאם למדינה, למחוז או למדינת המגורים שלך.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">10. בקרות לתכונות Do-Not-Track</h2>
              <p className="mb-8">רוב דפדפני האינטרנט וחלק ממערכות ההפעלה הניידות והאפליקציות הניידות כוללים תכונה או הגדרה של Do-Not-Track ("DNT") שתוכל להפעיל כדי לאותת על העדפת הפרטיות שלך לא לעקוב ולאסוף נתונים על פעילויות הגלישה המקוונות שלך.</p>

              <h2 className="text-2xl font-bold mt-8 mb-4">11. האם אנו מעדכנים הודעה זו?</h2>
              <p className="mb-8"><em>בקצרה: כן, נעדכן הודעה זו לפי הצורך כדי להישאר בהתאם לחוקים הרלוונטיים.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">12. כיצד ניתן ליצור איתנו קשר בנוגע להודעה זו?</h2>
              <p className="mb-8">אם יש לך שאלות או הערות לגבי הודעה זו, תוכל לשלוח לנו אימייל לכתובת <a href="mailto:yoni2435@gmail.com" className="text-primary hover:underline">yoni2435@gmail.com</a>.</p>

              <h2 className="text-2xl font-bold mt-8 mb-4">13. כיצד תוכל לסקור, לעדכן או למחוק את הנתונים שאנו אוספים ממך?</h2>
              <p className="mb-8">בהתבסס על החוקים החלים במדינתך, ייתכן שיש לך זכות לבקש גישה למידע האישי שאנו אוספים ממך, פרטים על אופן העיבוד שלו, לתקן אי-דיוקים או למחוק את המידע האישי שלך. ייתכן שיש לך גם זכות לבטל את הסכמתך לעיבוד המידע האישי שלך.</p>
            </>
          ) : (
            <>
