        ...
        <div className="prose prose-sm dark:prose-invert max-w-none">
          {lang === "he" ? (
            <>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">3. כיצד אנו שומרים על בטיחות המידע שלך?</h2>
              <p className="mb-8"><em>בקצרה: אנו שואפים להגן על המידע האישי שלך באמצעות מערכת של אמצעי אבטחה ארגוניים וטכניים.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">4. מהן זכויות הפרטיות שלך?</h2>
              <p className="mb-8"><em>בקצרה: אתה רשאי לסקור, לשנות או לסיים את חשבונך בכל עת.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">5. האם אנו מעדכנים הודעה זו?</h2>
              <p className="mb-8"><em>בקצרה: כן, נעדכן הודעה זו לפי הצורך כדי להישאר בהתאם לחוקים הרלוונטיים.</em></p>

              <h2 className="text-2xl font-bold mt-8 mb-4">6. כיצד ניתן ליצור איתנו קשר?</h2>
